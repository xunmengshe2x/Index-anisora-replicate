'''
nohup python3 preprocess/extract-clip.py 0 2 >> clip.log 2>&1 &
nohup python3 preprocess/extract-clip.py 1 2 >> clip.log 2>&1 &
...
from fastvideo.bili_space.wan.modules.clip import CLIPModel
device="npu"
clip = CLIPModel(
    dtype=torch.float16,
    device=device,
