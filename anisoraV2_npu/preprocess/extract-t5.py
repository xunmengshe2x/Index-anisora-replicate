'''
nohup python3 preprocess/extract-t5.py 0 2 >> t5.log 2>&1 &
nohup python3 preprocess/extract-t5.py 1 2 >> t5.log 2>&1 &
...
from fastvideo.bili_space.wan.modules.t5 import T5EncoderModel
device="npu"
