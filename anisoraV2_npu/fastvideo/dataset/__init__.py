...
def getdataset(args):
    ...
    text_encoder_path = text_encoder_path if os.path.exists(text_encoder_path) else args.text_encoder_name

    tokenizer = AutoTokenizer.from_pretrained(text_encoder_path, cache_dir=args.cache_dir)
