...
class WanI2V:
    ...
    def prepare_extra_step_kwargs(self, generator, eta):
        ...
        # eta (¦Ç) is only used with the DDIMScheduler, it will be ignored for other schedulers.
        # eta corresponds to ¦Ç in DDIM paper: https://arxiv.org/abs/2010.02502
    ...
    def generate(self,
        ...
        with amp.autocast(dtype=self.param_dtype), torch.no_grad(), no_sync():
            device = self.device
            sample_scheduler = FlowMatchEulerDiscreteScheduler(shift=7.0)
