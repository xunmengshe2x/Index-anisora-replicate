...
# from fastvideo.utils.communications import gather_sequence,split_sequence,all_to_all as all_to_all_4D
__all__ = ['WanModel']
...
class WanModel(ModelMixin, ConfigMixin):
    ...
    def forward(
        ...
        # Context Parallel
        # print(111111,x.shape)#torch.Size([1, 20280, 5120])##20280/8=2535.0
        if nccl_info.sp_size > 1:
