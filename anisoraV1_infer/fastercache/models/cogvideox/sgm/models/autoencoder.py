...
class AbstractAutoencoder(pl.LightningModule):
    ...
    def apply_ckpt(self, ckpt: Union[None, str, dict]):
        ...
        if isinstance(ckpt, str):
            ckpt = {
                "target": "fastercache.models.cogvideox.sgm.modules.checkpoint.CheckpointEngine",
...
class AutoencodingEngineLegacy(AutoencodingEngine):
    def __init__(self, embed_dim: int, **kwargs):
        ...
        super().__init__(
            encoder_config={
                "target": "fastercache.models.cogvideox.sgm.modules.diffusionmodules.model.Encoder",
                "params": ddconfig,
            },
            decoder_config={
                "target": "fastercache.models.cogvideox.sgm.modules.diffusionmodules.model.Decoder",
                "params": ddconfig,
            },
            **kwargs,
        )
