...
if [ "$TRANSFORMERS_OFFLINE" = 1 ]; then
    ...
    model_name_or_path="/DATA/bvac/personal/video_generation/benchmark/VideoScore/Mantis/mantis/Mantis-8B-Idefics2"
else
...
RUN_NAME="mantis-8b-idefics2-video-eval-24frame-benchmark"
