...
def attention_forward_default(self, hidden_states, mask, **kw_args):
    ...
    if "sp_pad" in kw_args:
        ...
        # print(11111111111111111,kw_args["sp_pad"])
    else:
        _sp_pad = 0
    ...
    # print("###############")
    # print(23333333333,"text_length_split" in kw_args,"sp_gp" in kw_args,kw_args["sp_gp"] != None,"sp_pad" in kw_args,query_layer.shape,key_layer.shape,value_layer.shape)#True#[1, 6, 33890, 64]
    # print("###############")
    context_layer = attention_fn(query_layer, key_layer, value_layer, mask, dropout_fn, **kw_args)

    # print("###############")
    # print(444444444,_sp_text_length!=None,_sp_gp != None)
    # print("###############")
